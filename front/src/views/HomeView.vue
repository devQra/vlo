...
import '@/assets/style/view/HomeView.scss'
import { ref } from 'vue'
    ...
    <div class="home-top-container">
      <div class="home-left-container">
        <div
          ...
          :class="sortState === 'trend' ? `home-sort home-select-sort action` : `home-sort action`"
        >
          <svg
            width="20"
            height="14"
        ...
        <div
          ...
          :class="sortState === 'newest' ? `home-sort home-select-sort action` : `home-sort action`"
        >
          <svg
            width="20"
            height="20"
      ...
      <div class="home-right-container">
        <div class="home-view-change action">
          <svg
            width="22"
            height="22"
            viewBox="0 0 30 27"
